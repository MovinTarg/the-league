The Dojo League
For this assignment, we will be building another CRUD application that will put to test our skills with Dapper relationships. We are going to build a site that tracks various Ninjas and the Dojos they are currently training under. For this, the following things are required.
